...
Datapool.prototype = {
	//returns usable twit obj given an id, screen name, or alias
	auth: function(who) {
		return this.twitters[who] ||
			this.twitters[_.invert(this.lookup)[who]] || (
			_.contains(this.mistress.alias, who) ?
			this.twitters[this.mistress.id_str] :
			_.contains(this.insect.alias, who) ?
			this.twitters[this.insect.id_str] :
			undefined
		);
	}
}
